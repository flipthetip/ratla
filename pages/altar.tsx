      ...
      <div className={styles.main}>
        ...
        <div className={styles.main}>
          ...
          <div className='justify-center content-center'>
            <a href="https://twitter.com/intent/tweet?screen_name=bunniezsol&ref_src=twsrc%5Etfw" className="twitter-mention-button" data-size="large" data-text="made me sacrifice my @shadies_NFT for Bunniez! #RIPSHADIES Go to https://altar.theshadyclass.xyz/ to sacrifice yours!" data-show-count="false">Tweet to #RIPSHADIES</a>
          </div>
          <br/>
