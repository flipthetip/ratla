...
const Home: NextPage = () => {
  ...
  const sacri = [
    ...
    // {	wallet:	'GWM1RvEM2YPonCUE1bvdvDR3v2T7szAwaTanRPUEwoHd'	,	bunniez:	'👑 65 🥇' 	},
    ...
    // {	wallet:	'GVerbUNY8RTFg3qMWsPiYQbPLwDL2X6cejP3Jy2Gyokn'	,	bunniez:	'11'	},
    ...
    // {	wallet:	'GQvaMGd1CMESWx3YHCaM5Fofb1Ty859VbsXZXwrWZA9D'	,	bunniez:	'2'	},
    // {	wallet:	'J15We6KkbpBmhj6mKsZAQRwHzaeQyHsRjRe6HsMEafMy'	,	bunniez:	'2'	},
    ...
    // {	wallet:	'GNq2V9VjKvFhAFSPgJz17yaafWhPuxHPJfmsmpRw3hTj'	,	bunniez:	'1'	},
    ...
    {	wallet:		'AayTwf3Qf7XpFoiQLVHHzf4L6VFkjBwBwZcKZT5KCrMZ'		,	bunniez:	16	},
    {	wallet:		'HnTgvonz24TEJ1w9VxFPRxC76W8UuQzb9NfqPxXMHvgU'		,	bunniez:	15	},
    {	wallet:		'4QbxRRgrhXCiQ4NGgXFiAbDCT533wvryyaPd9AcwVM9S'		,	bunniez:	12	},
    {	wallet:		'GVerbUNY8RTFg3qMWsPiYQbPLwDL2X6cejP3Jy2Gyokn'		,	bunniez:	11	},
    {	wallet:		'8eT4VG9EsBbCzetSeZayhWaRcymkhuiZfAAuVB3t3XRi'		,	bunniez:	11	},
    {	wallet:		'4RLnYSkYKKNwKTK2fDyhjd1g5HRywxbAZ9kjTMeWtd99'		,	bunniez:	10	},
    {	wallet:		'Gnte8z3r4Jwdwm85Y2udyXhu1aZwdgunnT84aSocEtoM'		,	bunniez:	10	},
    {	wallet:		'EsMvk4t684ceDVYiKt7vydtqSHofseErnUje3hXKdWvM'		,	bunniez:	8	},
    {	wallet:		'BWZcvSf9THcxBfJ8eiqqEeGhb9Xs47SWBK4un7X31ALg'		,	bunniez:	7	},
    {	wallet:		'223bHQL6QTdXaABSi6FDWvxn4ryq5bupnFyfAyi8bCsW'		,	bunniez:	7	},
    {	wallet:		'8KtVpvHLfz7tVXUqVjFbkQSRTS46GPGFfNzJsR7kcNhJ'		,	bunniez:	6	},
    {	wallet:		'APZxQkEDVZovNxrk4sQt3FTUHVjZ3F7f4wyXUh3o2xMe'		,	bunniez:	6	},
    {	wallet:		'6m4JHBytdccTTDUhPVN6YSHVnWA9nXXe4whbFDCFd2RZ'		,	bunniez:	5	},
    {	wallet:		'B4yPWKFtGHESYPDd7sbtJPFLmk2wFZ2xc7pZqLkveAem'		,	bunniez:	5	},
    ...
    {	wallet:		'8JPu9aGrcDXRKaxMRah3shWB6La9QrbLf9AnCBwjQGfa'		,	bunniez:	2	},
    {	wallet:		'HsCbC2swVB66M9Rks1bCPt3HRuwmKa3irSshxApkJCVu'		,	bunniez:	2	},
    {	wallet:		'3qtxTpx54xEhX8Rn6BcnJoC5v4Q2jwF6EdYhfxYCVou5'		,	bunniez:	2	},
    {	wallet:		'GNq2V9VjKvFhAFSPgJz17yaafWhPuxHPJfmsmpRw3hTj'		,	bunniez:	1	},
    {	wallet:		'C6yMvV8hFdzRmQ6ZtvGKm1PwB15Fxh7BTn66hApjHUYV'		,	bunniez:	1	},
    {	wallet:		'4cPjgKpYU7ryBJp8K191uxjpWFyXqfzdotZhMjPXqysU'		,	bunniez:	1	},
    {	wallet:		'GpR6UsyRjo3XAiJrBZXs8PpKRcJG4zUPKQrzY24NZvRS'		,	bunniez:	1	},
    ...
    {	wallet:		'DC7rNdH2xWXr3dpqtuzLMq8dPLZ175c8dMfCHbzaXdiX'		,	bunniez:	1	},
    {	wallet:		'GbQpWGJ7fxheP4F4EkXJhiTYyrtVk93Z369qLuftNYFR'		,	bunniez:	1	},
    {	wallet:		'AfXfGaqzCxm1BM2MnSmUE3FR4cdZU9uUdKkqb7kdzt8X'		,	bunniez:	1	},
    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <div className='grid grid-col-2 text-xs justify-center align-center'>
          ...
          <br/>
          <h5 className='justify-center align-center text-gray-500 text-lg '>Last Updated: 04/17/2023 05:00 UTC 🥕</h5>
